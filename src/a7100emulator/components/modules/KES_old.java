 ...
 *              - AFP hinzugefügt
 *   14.02.2016 - Als Kopie von KES.java erstellt
 */
 ...
 * @author Dirk Bräuer
 */
public final class KES_old implements IOModule, ClockModule, SubsystemModule {
     ...
     * Wake-Up-Adresse
     */
    private final int wakeupAddress = 0x0100;
...
//                        System.out.println();
    ...
    public int readLocalPort(int port) {
        switch (port) {
            ...
            case LOCAL_PORT_DMA_3:
                int result=dma.readStatus();
                System.out.println("Lese von DMA-Port: "+String.format("%02X",result));
                return result;
            case LOCAL_PORT_CTC_CHANNEL_0:
                System.out.println("Lesen von CTC0-Port noch nicht implementiert");
                return ctc.readChannel(0);
            case LOCAL_PORT_CTC_CHANNEL_1:
                System.out.println("Lesen von CTC1-Port noch nicht implementiert");
                return ctc.readChannel(1);
            case LOCAL_PORT_CTC_CHANNEL_2:
                System.out.println("Lesen von CTC2-Port noch nicht implementiert");
                return ctc.readChannel(2);
            case LOCAL_PORT_CTC_CHANNEL_3:
                System.out.println("Lesen von CTC3-Port noch nicht implementiert");
    ...
    public void writeLocalPort(int port, int data) {
        switch (port) {
            ...
            case LOCAL_PORT_DMA_3:
                ...
                System.out.println("Schreiben von DMA-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_CTC_CHANNEL_0:
                ctc.writeChannel(0, data);
                System.out.println("Schreiben von CTC0-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_CTC_CHANNEL_1:
                ctc.writeChannel(1, data);
                System.out.println("Schreiben von CTC1-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_CTC_CHANNEL_2:
                ctc.writeChannel(2, data);
                System.out.println("Schreiben von CTC2-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_CTC_CHANNEL_3:
                ctc.writeChannel(3, data);
                System.out.println("Schreiben von CTC3-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_RESETCA1_0:
            case LOCAL_PORT_RESETCA1_1:
            case LOCAL_PORT_RESETCA1_2:
            case LOCAL_PORT_RESETCA1_3:
                System.out.println("Schreiben von RESETCA1-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_RESETCA2_0:
            case LOCAL_PORT_RESETCA2_1:
            case LOCAL_PORT_RESETCA2_2:
            case LOCAL_PORT_RESETCA2_3:
                System.out.println("Schreiben von RESETCA2-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_WAKEUPL_0:
            case LOCAL_PORT_WAKEUPL_1:
            case LOCAL_PORT_WAKEUPL_2:
            ...
            case LOCAL_PORT_SETINT1_0:
            case LOCAL_PORT_SETINT1_1:
                System.out.println("Schreiben von SETINT1-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_SETINT2_0:
            case LOCAL_PORT_SETINT2_1:
                System.out.println("Schreiben von SETINT2-Port noch nicht implementiert");
                break;
            case LOCAL_PORT_NMI_MAP_0:
            case LOCAL_PORT_NMI_MAP_1:
            case LOCAL_PORT_NMI_MAP_2:
            case LOCAL_PORT_NMI_MAP_3:
                System.out.println("Schreiben von NMI/MAP-Port noch nicht implementiert");
                break;
            case 0x90:
            case 0x91:
            case 0x92:
    ...
    public int readLocalByte(int address) {
        if (address < 0x2000) {
            ...
            return sram.readByte(address - 0x4000);
        } else if (address < 0x5000) {
            return afs.readByte(address);
        } else if (address < 0x6000) {
            System.out.println("Lesen von AFP!");
            return 0;
            ...
            System.out.println("Lesen aus Adressfenster für Systembuszugriff!");
            return 0;
        }
    }
    ...
    public int readLocalWord(int address) {
        if (address < 0x2000) {
            ...
            return sram.readWord(address - 0x4000);
        } else if (address < 0x5000) {
    ...
    public void writeLocalByte(int address, int data) {
        if (address < 0x2000) {
            ...
            sram.writeByte(address - 0x4000, data);
        } else if (address < 0x5000) {
            ...
            System.out.println("Schreiben in Adressfenster für Systembuszugriff!");
        }
    }
    ...
    public void writeLocalWord(int address, int data) {
        if (address < 0x2000) {
            ...
            sram.writeWord(address - 0x4000, data);
        } else if (address < 0x5000) {
            System.out.println("Schreiben auf AFS Eproms nicht erlaubt!");
        } else if (address < 0x6000) {
            System.out.println("Schreiben auf AFP Eproms nicht erlaubt!");
